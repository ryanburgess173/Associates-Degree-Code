...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="includes/private/accountManagement.php"><span class="glyphicon glyphicon-log-in"></span> Account
                </a></li>
            <li><a href="includes/private/logoutPage.php"><span class="glyphicon glyphicon-log-in"></span> Logout
                </a></li>
        </ul>
    </div>
</nav>
