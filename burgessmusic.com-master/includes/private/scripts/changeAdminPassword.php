...
if (isset($_SESSION['admin_id'])) {
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $sql_script = "SELECT password FROM administrators WHERE username='$username'";
        ...
        if ($query_result) {
            ...
            if (password_verify($oldPassword, $pp)) {
                ...
                if ($newPassword == $newPasswordConfirm) {
                    ...
                    $sql_change_password_script = "UPDATE administrators SET password = '$encryptedPassword' WHERE username = '$username'";
